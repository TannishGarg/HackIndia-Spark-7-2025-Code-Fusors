...
import MoodForm, { MoodFormValues } from "@/components/mood/MoodForm";
...
export default function MoodBasedTrip() {
  ...
  const [formData, setFormData] = useState<MoodFormValues | null>(null);
  
  const handleFormSubmit = (values: MoodFormValues) => {
    setFormData(values);
