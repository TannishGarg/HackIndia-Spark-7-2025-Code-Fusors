  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to GoGinie!",
      });
      
      // Navigate to the page they were trying to access or default to dashboard
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Enter your email and password to access your GoGinie account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-sm text-goginie-primary hover:underline"
                  >
          ...
          <CardFooter>
            <div className="text-center w-full">
              <p className="text-sm text-muted-foreground">
                ...
                <Link to="/signup" className="text-goginie-primary hover:underline inline-flex items-center">
