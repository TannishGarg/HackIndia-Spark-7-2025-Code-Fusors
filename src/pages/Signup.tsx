...
import { Compass, Mail, Lock, User, ArrowRight, ArrowLeft } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to GoGinie! Start planning your dream trip now.",
      });
      setIsLoading(false);
      navigate("/dashboard");
    }, 1500);
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Sign up to start planning your perfect trip with GoGinie
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  I agree to the{" "}
                  <Link to="/terms" className="text-goginie-primary hover:underline">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-goginie-primary hover:underline">
                    Privacy Policy
                  </Link>
                </label>
              </div>
          ...
          <CardFooter>
            <div className="text-center w-full">
              <p className="text-sm text-muted-foreground">
                ...
                <Link to="/login" className="text-goginie-primary hover:underline inline-flex items-center">
