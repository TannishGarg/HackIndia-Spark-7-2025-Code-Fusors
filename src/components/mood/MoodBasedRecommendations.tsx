...
export default function MoodBasedRecommendations({ formData, onReset }: MoodBasedRecommendationsProps) {
  const [isLoading, setIsLoading] = useState(true);
  const [recommendations, setRecommendations] = useState<Recommendation[]>([]);
  const [selectedRecommendation, setSelectedRecommendation] = useState<Recommendation | null>(null);
  
  useEffect(() => {
    // Simulate API call for recommendations based on mood, location and time period
    const fetchRecommendations = async () => {
      // In a real app, this would be an API call
      // For now, we'll generate some mock data based on the inputs
      ...
      const mockData: Record<string, Recommendation[]> = {
        adventurous: [
          ...
          },
          {
            ...
            location: formData.location,
            coordinates: [51.495, -0.11], // Example coordinates
            duration: "2-3 hours",
            crowdLevel: 3,
            priceLevel: 2,
        ...
        relaxed: [
          {
            ...
            location: formData.location,
            coordinates: [51.525, -0.08], // Example coordinates
            duration: "1-2 hours",
            crowdLevel: 2,
            priceLevel: 1,
          ...
          },
          {
            ...
            location: formData.location,
            coordinates: [51.535, -0.07], // Example coordinates
            duration: "1-3 hours",
            crowdLevel: 5,
            priceLevel: 2,
        ...
        romantic: [
          {
            ...
            location: formData.location,
            coordinates: [51.515, -0.05], // Example coordinates
            duration: "3 hours",
            crowdLevel: 4,
            priceLevel: 3,
        ...
        hungry: [
          {
            ...
            location: formData.location,
            coordinates: [51.495, -0.02], // Example coordinates
            duration: "1-2 hours",
            crowdLevel: 8,
            priceLevel: 2,
        ...
        tired: [
          {
            ...
            location: formData.location,
            coordinates: [51.505, -0.01], // Example coordinates
            duration: "2-4 hours",
            crowdLevel: 3,
            priceLevel: 3,
        ...
        energetic: [
          {
            ...
            location: formData.location,
            coordinates: [51.525, -0.03], // Example coordinates
            duration: "1-2 hours",
            crowdLevel: 7,
            priceLevel: 1,
